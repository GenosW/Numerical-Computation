...
if __name__ == "__main__":
    ...
    C = []
    # C*a=B
    N = (10**2, 10**3, 10**4, 10**5, 10**6, 10**8)
    N_numbers = len(N)
    for z in N:
        start = time.time() 
        S_small.append(S(z))
    ...
    for z in [10, 100, 1000]: B.append((S(z)-m.log(z))*(z**2))
